...
public class Main {
    ...
    // one bucket of paint.
    // The fourth parameter should be named extraBuckets. This parameter represents the bucket count that Bob has at
    // home.
    ...
    // area of 1.5.
    // *getBucketCount(7.25, 4.3, 2.35); → should return 14 since the wall area is 31.175, and a single bucket can
    // cover an area of 2.35.
    //
    ...
    // of 2.2.
    // *getBucketCount(3.26, 0.75); → should return 5 since the wall area is 3.26, and a single bucket can cover an
    // area of 0.75 .
    //
