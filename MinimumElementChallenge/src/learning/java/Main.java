...
public class Main {
	...
	// write your code here
        ...
        int[] retArray = readElements(count);
        int min = findMin(retArray);
...
//        TIP: Instantiate (create) the Scanner object inside the method. There are two scanner objects, one for
//        each of the two methods that are reading in input from the user.
