...
public class Main {
    ...
    // Write a class with the name learning.java.Main.SimpleCalculator. The class needs two fields (instance variables) with names
    ...
    //    TEST EXAMPLE
    //    TEST CODE:
    //    learning.java.Main.SimpleCalculator calculator = new learning.java.Main.SimpleCalculator();
    //    calculator.setFirstNumber(5.0);
    //    calculator.setSecondNumber(4);
    //    System.out.println("add= " + calculator.getAdditionResult());
    //    System.out.println("subtract= " + calculator.getSubtractionResult());
