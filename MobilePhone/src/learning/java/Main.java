...
public class Main {
    ...
    private static void addNewContact() {
        ...
        if (mobilePhone.addNewContact(newContact)) {
            ...
            System.out.println("Cannot add, " + " already on file");
        }
    }
    ...
    private static void queryContact() {
        ...
        System.out.println("Name: " + existingContactRecords.getName() +
                            " phone number is " + existingContactRecords.getNumber());
    }
    ...
    // Options: Quit, Print list of contacts, add a new contact, update existing contact, remove contact
    // and search/find contact.
    // When adding or updating make sure to check if the contact already exists (use name).
