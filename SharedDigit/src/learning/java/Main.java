...
public class Main {
    ...
    public static boolean hasSharedDigit(int digitOne, int digitTwo) {
        ...
        lastDigitOne = digitOne % 10;
        firstDigitOne = digitOne / 10;
        lastDigitTwo = digitTwo % 10;
        firstDigitTwo = digitTwo / 10;
        if (lastDigitOne == lastDigitTwo
                || lastDigitOne == firstDigitTwo
                || firstDigitOne == lastDigitTwo
    ...
    //
    // NOTE: The method hasSharedDigit should be defined as public static like we have been doing so far in the
    // course.
